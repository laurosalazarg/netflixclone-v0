...
//HSL 
import HLSTest from "../views/backend/movie/hlstest";
//DASH 
import DASHTest from "../views/backend/movie/dashtest";
 
 

//RTMPS
import RTMPSTest from "../views/backend/movie/rtmpstest";
    ...
    <TransitionGroup>
      ...
      >
       ...
       {/* // Blog */}
          ...
          {/* HSL Test */}
          <Route path="/hlstest" component={HLSTest} />
          {/* DASH Test */}          
          <Route path="/dashtest" component={DASHTest} />
 
          {/* RTMPS Test */}
          <Route path="/rtmpstest" component={RTMPSTest} />
