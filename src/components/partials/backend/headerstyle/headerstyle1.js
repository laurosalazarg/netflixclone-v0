                        ...
                        <ul className="d-flex align-items-center justify-content-end list-inline m-0">
                          <Dropdown as="li" className="nav-item m-">
                            ...
                            <Dropdown.Menu className="search-box iq-search-bar d-search p-0 m-0 dropdown-menu-right">
                              <Form action="/movie-details" className="searchbox">
                                ...
                                <Card.Body className="iq-card-body">
                                  ...
                                  <Link to="/movie-details" className="iq-sub-card">
                                    <div className="media align-items-center">
                                      ...
                                      />
                                      <div className="media-body">
                                        <h6 className="mb-0 ">Sound City</h6>
                                        <small className="font-size-12">
                                          1 hour ago
                                        </small>
                                      </div>
                  ...
                  <Navbar.Collapse className="">
                    <div className="menu-main-menu-container">
                      <Nav as="ul" id="top-menu" className="ml-auto">
                        ...
                        <li className="menu-item">
                          <Link to="/movie-details">Movies</Link>
                        </li>
                        <li className="menu-item">
                          <Link to="/hlstest">HLS Test</Link>
                        </li>
                        <li className="menu-item">
                         <Link to="/dashtest">DASH Test</Link>
                        ...
                        <li className="menu-item">
                          <Link to="/rtmpstest">RTMPS Test</Link>
                        </li>
                        <li className="menu-item">
                          <Link to="/movie-details">Pages</Link>
                          <ul className="sub-menu">
                            <li className="menu-item">
                              <Link to="/movie-details">About Us</Link>
                            </li>
                            <li className="menu-item ">
                              <Link to="/movie-details">Contact</Link>
                            </li>
                            <li className="menu-item">
                              <Link to="/movie-details">FAQ</Link>
                            </li>
                            <li className="menu-item">
                              <Link to="/movie-details">Privacy-Policy</Link>
                            </li>
                            <li className="menu-item">
                              <Link to="/movie-details">Pricing</Link>
                              <ul className="sub-menu">
                                <li className="menu-item">
