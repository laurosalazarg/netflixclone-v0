...
//img
import banner from "../../../assets/images/movies/01.jpg";
...
import movie6 from "../../../assets/images/movies/01.jpg";
import movie7 from "../../../assets/images/movies/07.jpg";
import movie8 from "../../../assets/images/movies/07.jpg";
import movie9 from "../../../assets/images/movies/07.jpg";
import movie10 from "../../../assets/images/movies/07.jpg";
            ...
            <Link to="/movie-details">
              <div className="shows-img">
                ...
                <div className="shows-content">
                  <h4 className="text-white mb-1">Sound City</h4>
                  ...
                  >
                    <SwiperSlide className="slide-item">
                      <div className="block-images1 block-images position-relative">
                        ...
                        <div className="block-description">
                          <h6 className="iq-title">
                            <Link to="/movie-details">Sound City</Link>
                          </h6>
                          <div className="movie-time d-flex align-items-center my-2">
                            <div className="badge badge-secondary p-1 mr-2">
                              20+
